...
**Severity:** medium
**Timestamp:** 2025-06-29T04:45:05.029816

## User Description
No description provided

## Error Details
**User Message:** Please allocate more qubits before using them
**Technical Message:** Attempted to use qubit that wasn't allocated

## Context
- **Component:** QuantumCircuit
- **Operation:** build_circuit
- **User Action:** Called build_problematic_circuit
...
Traceback (most recent call last):
  File "/Users/alctoria/Superposia-Demo/quantum_platform/errors/decorator.py", line 48, in wrapper
    return func(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/alctoria/Superposia-Demo/example_error_handling_simple.py", line 160, in build_problematic_circuit
    raise QubitError(
quantum_platform.errors.exceptions.QubitError: Attempted to use qubit that wasn't allocated
...
---
*Report ID: QP-20250629-69276a34*
