...
**Severity:** medium
**Timestamp:** 2025-06-29T04:44:47.287771
...
Traceback (most recent call last):
  File "/Users/alctoria/Superposia-Demo/quantum_platform/errors/decorator.py", line 48, in wrapper
    return func(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/alctoria/Superposia-Demo/example_error_handling_simple.py", line 159, in build_problematic_circuit
    raise QubitError(
...
---
*Report ID: QP-20250629-5276646e*
